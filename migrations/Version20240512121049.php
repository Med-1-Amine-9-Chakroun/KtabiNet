 ...
 */
final class Version20240512121049 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE data (id INT AUTO_INCREMENT NOT NULL, id_client INT NOT NULL, id_livre INT NOT NULL, categorie_livre VARCHAR(255) NOT NULL, date_consult DATE NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
